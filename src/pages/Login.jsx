...
export default function Login() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (savedRedirect) { localStorage.removeItem("redirectAfterLogin"); navigate(savedRedirect); }
  ...
  return (
    <div style={styles.page}>
      <div style={styles.leftPanel}>
        ...
        <h2 style={styles.heroText}>Welcome<br />back.</h2>
        <p style={styles.heroSub}>Your trips, expenses, and friends<br />are waiting for you.</p>
        <div style={styles.pillRow}>
          {["✈ Your Trips", "💰 Expenses", "👥 Your Crew"].map(p => (
...
const styles = {
  ...
  heroText: { fontSize: "2.8rem", fontWeight: "normal", lineHeight: 1.2, margin: "0 0 20px 0" },
